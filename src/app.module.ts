...
@Module({
  ...
  imports: [StudentModule, UserModule], // en se encuentran todos los registros de los modulos de la app, IMPORTANTE si no se declara aca el modulo no se podran acceder a las rutas de los modulos
